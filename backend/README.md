...
## Project Structure
    ...
    ├── testapiautoteammemb_64300  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_64300`
...
2. Clone this repo and `cd testapiautoteammemb_64300`
